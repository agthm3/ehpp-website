    ...
    <footer class="flex text-center px-4 py-8 justify-center">
      <p class="text-sm">
        Copyright 2022 • Made with  ❤ <a href="https://www.instagram.com/agthm_.3/">Andi Gigatera Halil M</a>. | Design Reference <a href="https://www.instagram.com/buildwithangga/">Angga</a>
