          ...
          <div class="w-auto">
            ...
            >
              <li class="mx-3 py-6 md:py-0">
                ...
                <a href="#" class="text-black md:text-{{\Route::current()->getname()== 'index' ? 'black': ''}} hover:underline"
                  >Showcase</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
              ...
              <li class="mx-3 py-6 md:py-0">
                ...
                @auth
                  <li class="mx-3 py-6 md:py-0">
                    {{-- Pada kasus yang sama, menggunakan ternary operator untuk menantukan apakah navbar sedang berada di index atau bukan --}}
                    <a href="{{route('dashboard.index')}}" class="text-black md:text-{{\Route::current()->getname()== 'index' ? 'black': ''}} hover:underline"
                      >Dashboard</a
                    >
                  </li>
                @endauth
                @guest
                  <li class="mx-3 py-6 md:py-0">
                    {{-- Pada kasus yang sama, menggunakan ternary operator untuk menantukan apakah navbar sedang berada di index atau bukan --}}
                    <a href="{{route('login')}}" class="text-black md:text-{{\Route::current()->getname()== 'index' ? 'black': ''}} hover:underline"
                      >Login</a
                    >
                  </li>
                  ...
                  <li class="mx-3 py-6 md:py-0">
                    {{-- Pada kasus yang sama, menggunakan ternary operator untuk menantukan apakah navbar sedang berada di index atau bukan --}}
                    <a href="{{route('register')}}" class="text-black md:text-{{\Route::current()->getname()== 'index' ? 'black': ''}} hover:underline"
                      >Register</a
                    >
                  </li>
                @endguest
          ...
          <div class="w-auto">
            <ul class="items-center flex">
              ...
              <li class="ml-6">
                <a
                  id="header-cart"
                  class="flex items-center justify-center w-8 h-8 text-black md:text-{{\Route::current()->getname()== 'index' ? 'black': ''}}"
                  href="{{route('cart')}}"
                >
                  <svg
                    class="fill-current"
