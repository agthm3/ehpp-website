...
class ProductGalleryController extends Controller
{
    ...
    public function index(Product $product)
   {
    ...
    {
        //mengambil gambar pada field files, dimasukkan ke variabel files
        //atau menampung semua data yang ada di field files
        $files = $request->file('files');

        //melakukan pengecekan apakah ada gambar atau tidak, 
        //dan jika ada, kita looping menjadi satu", dan akan di upload ke variabel $Path
